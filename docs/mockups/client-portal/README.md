# BSS Hub — Visual Reference Mockups

Reference mockups guiding visual parity work across the BSS Hub (Owner Hub + Client Portal) and the Client Notifications™ email system. See sibling folders: `../owner-hub/`, `../blueprint/`, `../emails/`.

## Client Portal — received
- `dashboard.png` — original dashboard concept (cream sidebar, hero + progress snapshot)
- `dashboard-v2.png` — revised dashboard concept (dark sidebar, reward points, transformation preview, quick actions)
- `appointments.png` — original appointments view (cream sidebar, week calendar + next appointment sidebar)
