...
import { createSignedAvatarUploadUrl, updateOwnAvatar } from "./actions";
import { createSupabaseBrowserClient } from "@/lib/supabase/client";

export default function PortalAvatarUploadWidget() {
  ...
  function handleChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    startTransition(async () => {
      const signed = await createSignedAvatarUploadUrl(file.name);
      ...
      await updateOwnAvatar(signed.path);
      router.refresh();
    });
  }
