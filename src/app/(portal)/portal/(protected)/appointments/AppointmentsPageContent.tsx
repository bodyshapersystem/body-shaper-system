...
/**
 * Real, shared appointments data + view — used by both the standalone
 * /portal/appointments page and the new Systems & Sessions "sessions"
 * tab, so both surfaces show the exact same real upcoming/past
 * appointment data with zero duplication. Assumes the caller already
 * confirmed the client is signed in.
 */
export default async function AppointmentsPageContent({ heading = true }: { heading?: boolean } = {}) {
