...
export async function recordRenphoScan(clientId: string, assessmentId: string, formData: FormData) {
  ...
  await prisma.measurement.create({
    data: {
      ...
      neckCm: num("neckCm"),
      shoulderCm: num("shoulderCm"),
      bicepsLeftCm: num("bicepsLeftCm"),
      bicepsRightCm: num("bicepsRightCm"),
      chestCm: num("chestCm"),
      waistCm: num("waistCm"),
      abdomenCm: num("abdomenCm"),
      hipCm: num("hipCm"),
      thighLeftCm: num("thighLeftCm"),
      thighRightCm: num("thighRightCm"),
      calfLeftCm: num("calfLeftCm"),
      calfRightCm: num("calfRightCm"),
