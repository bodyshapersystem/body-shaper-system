        ...
        <table className="simple-table" style={{ width: "100%" }}>
          <thead>
            <tr>
              ...
              <th style={{ padding: "10px 8px" }}>Society Points</th>
        ...
        <div className="apd-overlay" onClick={() => setSelected(null)}>
          <div className="apd-panel" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="apd-detail-list">
              <div className="apd-detail-row"><span>current Society Points</span><strong>{selected.pointsBalance.toLocaleString()}</strong></div>
              <div className="apd-detail-row"><span>lifetime Society Points</span><strong>{selected.lifetimePoints.toLocaleString()}</strong></div>
            ...
            {canManage && (
              <div className="apd-actions">
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <button type="button" className="apd-btn-secondary" style={{ flex: 1 }} disabled={isPending} onClick={() => handleAdjust(1)}>Add Society Points</button>
                  <button type="button" className="apd-btn-secondary" style={{ flex: 1 }} disabled={isPending} onClick={() => handleAdjust(-1)}>Remove Society Points</button>
                </div>
