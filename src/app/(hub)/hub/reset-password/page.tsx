...
export default function HubResetPasswordPage() {
  ...
  useEffect(() => {
    ...
    async function establishSession() {
      // Supabase's reset link can arrive as either a `code` query param
      // (PKCE flow) or tokens in the URL hash (implicit flow) — handle
      // both so this works regardless of project auth settings.
        ...
        <div className="auth-form-card">
          {success ? (
            <>
              ...
              <Link href="/hub/login" className="auth-submit" style={{ display: "block", textAlign: "center", textDecoration: "none" }}>
                Return to Sign In
              </Link>
            </>
          ) : sessionError ? (
            <>
              ...
              <Link href="/hub/forgot-password" className="auth-submit" style={{ display: "block", textAlign: "center", textDecoration: "none" }}>
                Request New Link
              </Link>
            </>
          ) : !ready ? (
            ...
            <>
              ...
              <p className="auth-form-sub">Choose a new password for your Owner Hub account.</p>
