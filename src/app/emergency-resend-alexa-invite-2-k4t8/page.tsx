...
export default async function EmergencyResendAlexaInvite2Page({ searchParams }: { searchParams: Promise<{ token?: string }> }) {
  ...
  if (!client.portalInvite) return <div style={{ padding: 40, fontFamily: "monospace" }}>No invitation record exists for this client.</div>;
